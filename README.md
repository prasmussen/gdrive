...
- [Installation](#installation)
  - [With Homebrew On Mac](#with-homebrew-on-mac)
  - [Other](#other)
- [Downloads](#downloads)
...
- [Gdrive 2](#gdrive-2)
  ...
  - [.gdriveignore](#gdriveignore)
- [Usage](#usage)
  - [List Files](#list-files)
  - [Download File Or Directory](#download-file-or-directory)
  - [Download All Files And Directories Matching Query](#download-all-files-and-directories-matching-query)
  - [Upload File Or Directory](#upload-file-or-directory)
  - [Upload File From Stdin](#upload-file-from-stdin)
  - [Update File This Creates A New Revision Of The File](#update-file-this-creates-a-new-revision-of-the-file)
  - [Show File Info](#show-file-info)
  - [Create Directory](#create-directory)
  - [Share File Or Directory](#share-file-or-directory)
  - [List Files Permissions](#list-files-permissions)
  - [Revoke Permission](#revoke-permission)
  - [Delete File Or Directory](#delete-file-or-directory)
  - [List All Syncable Directories On Drive](#list-all-syncable-directories-on-drive)
  - [List Content Of Syncable Directory](#list-content-of-syncable-directory)
  - [Sync Drive Directory To Local Directory](#sync-drive-directory-to-local-directory)
  - [Sync Local Directory To Drive](#sync-local-directory-to-drive)
  - [List File Changes](#list-file-changes)
  - [List File Revisions](#list-file-revisions)
  - [Download Revision](#download-revision)
  - [Delete File Revision](#delete-file-revision)
  - [Upload And Convert File To A Google Document See About Import For Available Conversions](#upload-and-convert-file-to-a-google-document-see-about-import-for-available-conversions)
  - [Export A Google Document](#export-a-google-document)
  - [Google Drive Metadata Quota Usage](#google-drive-metadata-quota-usage)
  - [Show Supported Import Formats](#show-supported-import-formats)
  - [Show Supported Export Formats](#show-supported-export-formats)
- [Examples](#examples)
  - [List Files](#list-files-1)
  - [List Largest Files](#list-largest-files)
  - [Upload File](#upload-file)
  - [Make Directory](#make-directory)
  - [Upload File To Directory](#upload-file-to-directory)
  - [Download File](#download-file)
  - [Share A File](#share-a-file)
  - [Pipe Content Directly To Google Drive](#pipe-content-directly-to-google-drive)
  - [Print File To Stdout](#print-file-to-stdout)
  - [Get File Info](#get-file-info)
  - [Update File Create New Revision](#update-file-create-new-revision)
  - [List File Revisions 1](#list-file-revisions-1)
  - [Download Revision 1](#download-revision-1)
  - [Export Google Doc As Docx](#export-google-doc-as-docx)
  - [Import Csv As Google Spreadsheet](#import-csv-as-google-spreadsheet)
  - [Syncing Directory To Drive](#syncing-directory-to-drive)
  - [List Content Of Sync Directory](#list-content-of-sync-directory)
## Prerequisites
