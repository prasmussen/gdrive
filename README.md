...
## Note
This is only a Hotfix. You should use the offical edition (https://github.com/gdrive-org/gdrive) if the error is fixed.
...
### Downloads
Windows and Linux: https://github.com/Exonip/gdrive/releases/tag/2.2.0
